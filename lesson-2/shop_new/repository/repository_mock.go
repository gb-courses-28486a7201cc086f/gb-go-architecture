...
func (m *mapDBErrorMock) CreateOrder(order *models.Order) (*models.Order, error) {
	return nil, errors.New("mock: test error")
}

func (m *mapDBErrorMock) ListOrders(filter *OrderFilter) ([]*models.Order, error) {
	return []*models.Order{}, errors.New("mock: test error")
}
